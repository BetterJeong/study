<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" errorPage="addrbook_error.jsp" import="jspbook2.*"%>
<!DOCTYPE HTML>
<html>
<head>
...
<jsp:useBean id="ab" scope="request" class="jspbook2.AddrBook" />
	...
	<div align="center">
		...
		<form name=form1 method=post action=addrbook_control.jsp>
			...
			<table border="1">
				...
				<tr>
					<th>주 소</th>
					<td><input type="text" name="ab_address"
						value="<%=ab.getAb_address()%>"></td>
				</tr>
				<tr>
					<th>메 모</th>
